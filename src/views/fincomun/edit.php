        ...
        <div class="form-container">
            ...
            <div class="right-column">
                ...
                <select class="form-select from-filtro" name="status_blm" required>
                    ...
                    <option value="Cerrado" <?= $registro['status_blm'] == 2 ? 'selected' : '' ?>>Cerrado</option>
                    <option value="Cancelado" <?= $registro['status_blm'] == 3 ? 'selected' : '' ?>>Cancelado</option>
                </select>


                <label for="resolucion">RESOLUCIÓN DE FINCOMUN:</label>
                <input type="text" id="resolucion" name="resolution_fincomun_blm" value="<?= $registro['resolution_fincomun_blm'] ?>">

                <label for="cuenta">CUENTA FINCOMUN:</label>
                <input type="number" id="cuenta" name="account_fincomun" value="<?= $registro['account_fincomun'] ?>">

                <label for="fecha">FECHA DE RESOLUCIÓN:</label>
                <input type="date" id="fecha" name="resolution_date_blm" value="<?= htmlspecialchars($registro['resolution_date_blm']) ?>">

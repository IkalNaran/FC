    ...
    <main class="main-solicitud">
        <div class="form-container">
            ...
            <div class="right-column">
                ...
                <select class="form-select from-filtro" name="status_blm" aria-label="Default select example" required>
                        <option selected>Abierto</option>
                </select>

                <label for="resolucion" hidden>RESOLUCIÓN DE FINCOMÚN:</label>
                <input type="text" id="resolucion" name="resolution_fincomun_blm" hidden>
